    ...
    <main className="max-w-2xl mx-auto py-12 px-4 sm:px-8">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          des Données (RGPD) et à protéger votre vie privée.
        </p>
        <p>
          Notre site a été conçu pour minimiser la collecte de données
          personnelles. Nous ne collectons aucune information personnelle hormis
          :
        </p>
        <ul className="list-disc ml-6">
          <li>
            Les données nécessaires au fonctionnement des publicités Google
            AdSense (si vous acceptez les cookies)
          </li>
          <li>
            Les informations que vous nous transmettez volontairement via le
      ...
      <section className="mb-6">
        ...
        <p>
          Nous ne collectons pas : adresse IP, localisation précise, données de
          paiement, ou toute autre information sensible.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          ...
          <li>
            Notre intérêt légitime à répondre aux demandes via le formulaire de
            contact
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          <li>
            Données AdSense : Selon la politique de conservation de Google
            (gérée par vos paramètres de compte Google)
          </li>
          <li>
            Messages du formulaire : Conservés pendant 1 an maximum après le
            dernier contact, sauf demande de suppression anticipée
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          Pour exercer ces droits concernant le formulaire de contact :{" "}
          <span className="font-semibold">nous contacter</span>
        </p>
        <p>
          Pour les données publicitaires : paramètres de votre compte Google ou
      ...
      <section className="mb-6">
        ...
        <p>Tous nos sous-traitants sont conformes au RGPD.</p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          <li>
            Protocole HTTPS pour toutes les transmissions grâce à notre
            hébergeur.
          </li>
