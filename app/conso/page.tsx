...
const faqData = [
	...
	{
		question: "Peut-on rembourser un crédit à la consommation par anticipation ?",
		answer:
...
export default function Conso() {
	...
	return (
		<main className="max-w-2xl mx-auto py-12 px-4 sm:px-8">
			...
			<p className="mb-8">
				Calculez votre mensualité de crédit en fonction du montant emprunté, de la
				durée et du taux d'intérêt.
			</p>
			...
			<section className="mb-6">
				...
				<p>
					...
					évaluer l'impact financier de l'emprunt. Cela permet de savoir combien un
					emprunteur devra rembourser en plus du montant emprunté, en prenant en
					compte les intérêts et les frais associés.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<p>
					Le montant total remboursé correspond au montant emprunté, augmenté des
					intérêts et des éventuels frais. La formule de base pour calculer le
					montant total remboursé est la suivante :
				</p>
				...
				<p>
					...
					signifie que l'emprunteur devra rembourser 2 500 € en intérêts sur cinq
					ans.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<p>
					Le coût total du crédit dans cet exemple sera de 13 000 €, ce qui inclut
			...
			<section className="mb-6">
				...
				<p>
					Calculer le coût d'un crédit à la consommation permet à l'emprunteur de
					connaître exactement ce qu'il devra rembourser et d'évaluer si l'emprunt
					est en adéquation avec sa capacité de remboursement.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<ul className="list-disc ml-6 mb-2">
					<li>
						<strong>Crédit automobile :</strong> Calculer le coût d'un crédit pour
						acheter une voiture permet de déterminer le montant total à rembourser
						sur la durée du prêt.
					</li>
					<li>
						<strong>Crédit personnel :</strong> Calculer le coût d'un crédit
						personnel permet de savoir combien coûtera l'emprunt pour financer des
						projets personnels (voyage, rénovation, etc.).
					</li>
					<li>
						<strong>Crédit pour les études :</strong> Calculer le coût d'un crédit
						étudiant permet d'évaluer l'impact financier de l'emprunt pour
			...
			<section className="mb-6">
				...
				<ul className="list-disc ml-6 mb-2">
					<li>
						<strong>Évaluer le coût total :</strong> Le calcul permet de connaître
						le montant total à rembourser, y compris les intérêts et frais
						supplémentaires.
					</li>
					<li>
						<strong>Comparer des offres de crédit :</strong> En calculant le coût
						total des crédits proposés par différentes institutions, l'emprunteur
						peut choisir l'option la plus avantageuse.
					</li>
					<li>
						<strong>Gérer son budget :</strong> Calculer le coût d'un crédit permet
						à l'emprunteur de s'assurer qu'il peut rembourser l'emprunt sans mettre
						en péril ses finances personnelles.
					</li>
				</ul>
			</section>
