    ...
    <main className="max-w-2xl mx-auto py-12 px-4 sm:px-8">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          investissement. Il permet de savoir combien de gains un bien génère
          par rapport à son coût initial. Cela peut s'appliquer à divers types
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6 mb-2">
          <li>
            ...
            d'un bien immobilier permet de savoir si l'achat d'un bien est
            rentable en fonction de ses revenus locatifs.
          </li>
          <li>
