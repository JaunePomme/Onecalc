...
const faqData = [
	...
	{
		question: "Faut-il prendre en compte les impôts dans le calcul du rendement ?",
		answer:
	...
	return (
		<main className="max-w-2xl mx-auto py-12 px-4 sm:px-8">
			...
			<section className="mb-6">
				...
				<p>
					Le calcul du rendement est essentiel pour évaluer la rentabilité d'un
					investissement. Il permet de savoir combien de gains un bien génère par
					rapport à son coût initial. Cela peut s'appliquer à divers types
					d'investissements, tels que l'immobilier, les actions, ou les biens
					d'entreprise.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<p>
					Il existe différentes façons de calculer le rendement d'un investissement
					:
				</p>
			...
			<section className="mb-6">
				...
				<p>La formule de base pour calculer le rendement brut est la suivante :</p>
			...
			<section className="mb-6">
				...
				<p>
					Le rendement net dans cet exemple est de 6,5 %, ce qui est plus précis,
					car il tient compte des dépenses réelles associées au bien.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<ul className="list-disc ml-6 mb-2">
					<li>
						...
						d'un bien immobilier permet de savoir si l'achat d'un bien est rentable
						en fonction de ses revenus locatifs.
					</li>
					<li>
						<strong>Investissements en actions</strong> : Calculer le rendement
						d'un portefeuille d'actions permet de mesurer la rentabilité des
						dividendes et des gains en capital.
					</li>
					<li>
						<strong>Évaluations d'entreprise</strong> : Le rendement peut
						également être utilisé pour évaluer la rentabilité d'un bien ou d'un
						actif d'entreprise.
					</li>
				</ul>
			</section>
			...
			<section className="mb-6">
				...
				<ul className="list-disc ml-6 mb-2">
					<li>
						...
						connaître la rentabilité d'un investissement en comparaison de son
						côut initial.
					</li>
					<li>
					...
					<li>
						...
						rendement permet d'ajuster les stratégies d'investissement pour
