...
function calculateWaterIntake(weight: number, activityLevel: number) {
	return weight * 0.033 + activityLevel * 0.5;
}

export default function HydratationPage() {
	const t = useTranslations("Hydratation");
	...
	const handleCalc = (e: React.FormEvent) => {
		...
		try {
			...
			setResult(calculateWaterIntake(numWeight, numActivityLevel));
		} catch (err) {
			setResult(null);
