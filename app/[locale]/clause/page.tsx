export default function Clause() {
  return (
    <main className="max-w-2xl mx-auto py-12 px-4 sm:px-8">
      <h1 className="text-3xl font-bold mb-6">Clause de non-responsabilité</h1>

      <section className="mb-6">
        <p>
          Les informations fournies sur ce site web le sont à titre informatif
          et général uniquement. Bien que nous nous efforcions de maintenir les
          données à jour et exactes, aucune garantie n’est donnée quant à leur
          exhaustivité, fiabilité, pertinence ou exactitude, que ce soit de
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">
          Utilisation des outils et simulateurs
        </h2>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
          Tous les contenus présents sur ce site (textes, outils, logos, images,
          ...
          distribution, totale ou partielle, sans autorisation écrite préalable,
