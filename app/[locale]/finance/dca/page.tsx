...
function simulateDCA({
  ...
  for (let i = 0; i < periodes; i++) {
    const prix = prixInitial + ((prixFinal - prixInitial) * i) / (periodes - 1);
  ...
  return (
    ...
    >
      ...
      <form
        ...
        autoComplete="off"
      >
        <h2 id="dca-form-title" className="sr-only">
          {t("title")}
        </h2>
          ...
          {error ? (
            ...
            <>
              <span className="text-lg font-bold">
                {t("totalInvestiLabel")}{" "}
                {result.totalInvesti.toLocaleString(undefined, {
              ...
              <span className="text-lg font-bold">
                {t("prixMoyenLabel")}{" "}
                {result.prixMoyen.toLocaleString(undefined, {
              ...
              <span className="text-lg font-bold">
                {t("valeurFinaleLabel")}{" "}
                {result.valeurFinale.toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                })}{" "}
                €
              </span>
              ...
              <span className="text-lg font-bold">
                {t("perfLabel")}{" "}
                {result.perf.toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                })}{" "}
                €
              </span>
              ...
              <span className="text-lg font-bold">
                {t("perfPctLabel")}{" "}
                {result.perfPct.toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                })}{" "}
                %
              </span>
