  ...
  return (
    ...
    >
      ...
      <form
        ...
        autoComplete="off"
      >
        <h2 id="cout-form-title" className="sr-only">
          {t("title")}
        </h2>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6 mb-2">
          <li>
            <strong>{t("whyList_0_title")}</strong> {t("whyList_0_desc")}
          </li>
          <li>
            <strong>{t("whyList_1_title")}</strong> {t("whyList_1_desc")}
          </li>
          <li>
            <strong>{t("whyList_2_title")}</strong> {t("whyList_2_desc")}
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6 mb-2">
          <li>
            <strong>{t("reduceList_0_title")}</strong> {t("reduceList_0_desc")}
          </li>
          <li>
            <strong>{t("reduceList_1_title")}</strong> {t("reduceList_1_desc")}
          </li>
          <li>
            <strong>{t("reduceList_2_title")}</strong> {t("reduceList_2_desc")}
          </li>
          <li>
            <strong>{t("reduceList_3_title")}</strong> {t("reduceList_3_desc")}
          </li>
        </ul>
      </section>
