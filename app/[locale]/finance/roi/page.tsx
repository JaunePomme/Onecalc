...
export default function Roi() {
	...
	return (
		   <main className="max-w-2xl mx-auto py-12 px-4 sm:px-8" role="main" aria-label={t("title") + ' - ' + t("intro")}> 
			   ...
			   <p className="mb-8" id="roi-intro">{t("intro")}</p>
			   ...
			   <form
				   ...
				   autoComplete="off"
			   >
				   <h2 id="roi-form-title" className="sr-only">{t("title")}</h2>
				   ...
				   />
				   <div className="text-xs text-yellow-700 dark:text-yellow-400 flex items-center gap-2" id="roi-indicative">
					   {t("indicative")} {" "}
					   <a href="#faq" className="underline" aria-label={t("learnMore") + ' FAQ'}>
						   {t("learnMore")}
					   </a>
				   </div>
				   <button
